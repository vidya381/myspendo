...
export default function EditTransactionPage() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                // Fetch categories
                const categoriesRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "/api"}/category/list`, {
                ...
                const transactionRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "/api"}/transaction/list`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-200"
                    >
                        Back to Dashboard
                    </button>
                </div>
